...
function Bevy (conf) {
    ...
    // signal when an entry is unknown
    proxy.proxy.on("notFound", function (req, res) {
        res.writeHead(404, { "Content-Type": "text/html" });
        res.end("<h1>No such hostname</h1>", "utf-8");
    });
    ...
    function startAPI (port) {
        ...
        app.put("/app/:name", function (req, res) {
            ...
            desc.contentPath = (app.repository.type === "local") ? app.repository.path : pth.join(desc.storePath, "content");
